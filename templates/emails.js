...
const confirm_order_mail = (order_id) => {
  return(
    `
    <!DOCTYPE html
                    ...
                    <tr>
                      <td class="content-cell"
                        ...
                        <h1
                          ...
                          Hello Admin, a new Order has been placed
                        </h1>

                        <p>Click to confirm new order! Cheers 💪</p>

                        <div>
                          <button type="button"
                            style="background-color: #056424; border-radius: 0.525rem; padding-left: 20px; padding-right: 20px; cursor: pointer; height: 3rem;"><a
                              style='color: white; font-family: sans-serif; text-decoration: none;'
                              href="https://eden-dashboard.vercel.app/orders/${order_id}">Confirm order</a></button>
                        </div>

                        <p style="font-size: 13px;">
                          <i>Eden is an online shopping destination. <br> We pride ourselves in having everything you could
                            possibly need for your fashion lifestyle at the best prices than anywhere else.</i>
                        </p>
                      </td>
                    </tr>
                  </table>
